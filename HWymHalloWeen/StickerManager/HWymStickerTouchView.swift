...
class HWymStickerTouchView: TouchStuffView {
    ...
    let deleteBtnImgName: String = "edit_sticker_close_ic"
    let rotateBtnImgName: String = "sticker_edit_big_ic"
...
extension HWymStickerTouchView {
    func setupView() {
